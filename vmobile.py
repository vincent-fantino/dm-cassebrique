...
def update():
    ...
    global vaisseau_x, vaisseau_y, balle_y, balle_x, deplacement_vertical, deplacement_horizontal, vies, vitesse
    ...
    if balle_y >= 256 :
        ...
        balle_y = 128
        balle_x = 128
        deplacement_horizontal = random.randint(-1*vitesse,1*vitesse)
...
def draw():
    ...
    global vaisseau_x, vaisseau_y, balle_y, balle_x, deplacement_vertical, vies, vies_brique_1, vies_brique_2, vies_brique_3, deplacement_horizontal, vitesse
